...
### Known issues
Due to the huge size of the datasets, I couldn't upload them. In `static/data/processData` there is a file explaining how to download it after cloning the repo.